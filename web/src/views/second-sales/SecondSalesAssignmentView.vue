        ...
        <el-table-column label="操作" width="240" fixed="right">
          <template #default="scope">
            <div class="action-buttons-wrap">
              ...
              <el-button v-if="canCreateSecondSales()" type="success" link size="small" :disabled="!canSubmitSecondSales(scope.row)" @click="openOrderDrawer(scope.row)">{{ scope.row.arrearsAmount > 0 && scope.row.currentStatus !== '待转法务' && scope.row.currentStatus !== 'PENDING_LEGAL' ? '补尾款' : '录业绩' }}</el-button>
