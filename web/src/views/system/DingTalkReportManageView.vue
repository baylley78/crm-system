...
const templateVariables = ['{{stage}}', '{{customerName}}', '{{phone}}', '{{maskedPhone}}', '{{salesName}}', '{{departmentName}}', '{{teamName}}', '{{paymentAmount}}', '{{performanceAmount}}', '{{orderTime}}', '{{orderType}}', '{{isTimelyDeal}}', '{{dailyOrderCount}}', '{{dailyPaymentAmount}}', '{{departmentDailyPerformanceLines}}', '{{departmentDailyPerformanceTotal}}', '{{dailyTarget}}']
