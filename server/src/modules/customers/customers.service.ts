    ...
    return {
      ...
      legalCase: latestLegalCase
        ? {
            ...
            stage: latestLegalCase.stage,
            assistantCustomerSituationRemark: latestLegalCase.assistantCustomerSituationRemark,
            assistantFollowRemark: latestLegalCase.assistantFollowRemark,
            filingCustomerSituationRemark: latestLegalCase.filingCustomerSituationRemark,
            filingFollowRemark: latestLegalCase.filingFollowRemark,
            preTrialCustomerSituationRemark: latestLegalCase.preTrialCustomerSituationRemark,
            preTrialFollowRemark: latestLegalCase.preTrialFollowRemark,
